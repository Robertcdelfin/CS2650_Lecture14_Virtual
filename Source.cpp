...
public:
	...
	//Expecting someone dervied from base class to define the function 
	//Can define something as safety or strict or = 0 pure virtual function
	// called no defintion meaning you must define later on.
...
int main(int argc, char ** argv) {
	...
	//d.snap()  //who get called? The first is dog the second is Animal
	printf("%s\n", d.snap().c_str());
	printf("%s\n", d.Animal::snap().c_str());
